function [rewired_activity_ratio, rewired_FC_R]= null_TS_rewired_MPC_rsfMRI(X_RS,n_modes,n_nulls);
...
parfor null = 1:n_nulls  
    [W_null, ~] = null_model_und_sign(MPC);   
    ...
    U = Compute_Laplacian(final_matrix);   %% Laplacian Decomposition
    ...
    % Method1 for every subject's FC
